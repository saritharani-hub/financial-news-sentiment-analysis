...
print("=" * 70)
print("FINANCIAL NEWS SENTIMENT ANALYSIS - LSTM")
print("=" * 70)
...
history_df.to_csv(
    "models/lstm_training_history.csv",
    index=False
)
...
print(
    "1. models/lstm_model.keras"
)

print(
    "2. models/lstm_tokenizer.pkl"
)

print(
    "3. models/lstm_results.csv"
)

print(
    "4. models/lstm_predictions.csv"
)

print(
    "5. models/lstm_training_history.csv"
)
